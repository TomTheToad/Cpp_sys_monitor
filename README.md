# CppND-System-Monitor (Cloned: see student notes)
...
The original repository containing the starter code can be found [here](https://github.com/udacity/CppND-System-Monitor).
